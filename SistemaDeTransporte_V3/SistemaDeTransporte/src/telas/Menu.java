...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu(ArrayList<Usuario> usuarios, HashMap<String, TreeSet<String>> estadosCidades) {
        initComponents();
